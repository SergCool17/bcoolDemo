...
import {updateCommentCreator, sendCommentCreator} from "../../redux/sidebar-Reducer";

const Sidebar = (props) => {
    let state = props.store.getState();
    let sidebarPost = state.sidebar.popularPosts.map(el => <SidebarItem title={el.title} viewesCount={el.viewesCount} />)
    ...
    return (
        <div className={s.sidebar}>
            ...
            <textarea value={state.sidebar.newComment}
                    placeholder="Comment"
